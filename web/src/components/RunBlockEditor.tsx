...
function RunBlockQuestionEditor({question, setQuestion}: {
    question?: string;
...
function RunBlockOptionsEditor({options, setOptions}: {
    options?: string[];
    setOptions: (options?: string[]) => void;
}) {
    return <>
        {options && options.map((option, i) => <RunBlockOptionEditor
            option={option}
            optionIndex={i}
...
function RunBlockOptionEditor({option, optionIndex, setOption}: {
    option?: string;
    optionIndex: number;
...
function RunBlockOptionTypeEditor({optionType, setOptionType}: {
...
function RunBlockNameEditor({name, setName}: {
    name?: string;
...
function RunBlockPlateCountEditor({plateCount, setPlateCount}: {
    plateCount?: number;
...
function RunBlockPlateSizeEditor<T extends number = number>({plateSize, plateSizes, setPlateSize}: {
    plateSize?: T;
    plateSizes?: T[];
...
function RunBlockReagentLabelEditor({reagentLabel, setReagentLabel}: {
    reagentLabel?: string;
